...
import 'package:todo_app_news/modules/web_view/web_view.dart';
...
Widget buildArticleItem(list, context) => InkWell(
      onTap: () {
        navigateTo(context, WebViewExample(list['url']));
      },
      child: Padding(
...
Widget defButton({
  ...
  bool toUppercase = false,
    ...
    Container(
      decoration: BoxDecoration(
          color: bachground, borderRadius: BorderRadius.circular(radis)),
      width: width,
      height: height,
