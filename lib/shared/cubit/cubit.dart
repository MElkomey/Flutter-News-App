...
import 'package:todo_app_news/modules/archived_screen/archived_screen.dart';
import 'package:todo_app_news/modules/done_screen/done_screen.dart';
import 'package:todo_app_news/modules/tasks_screen/tasks_screen.dart';
...
void isBottomSheetChange({
  ...
  bool isDark=false;
   void appModeChange({bool? fromSharedPreferences}){
    if (fromSharedPreferences!= null){
     isDark=fromSharedPreferences;
     emit(GetNewsAppModeChangeState());
    }else{
      isDark=!isDark;
